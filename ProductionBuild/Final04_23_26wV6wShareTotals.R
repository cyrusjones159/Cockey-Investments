...
mediaresult2 <- sqldf("SELECT symbol, dividend_yield FROM mediamydf2 WHERE dividend_yield > 2 Order by dividend_yield DESC")
reitsresult2 <- sqldf("SELECT symbol, dividend_yield FROM reitsmydf2 WHERE dividend_yield > 3 Order by dividend_yield DESC")
